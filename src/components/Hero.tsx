...
const Hero = () => {
  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-gray-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      <div className="container-custom text-center">
        ...
        >
          ...
          >
            HNDIT Student | Web Developer | IT Enthusiast
          </motion.h2>
          ...
          >
            Passionate about technology and eager to learn, build, and grow in the IT industry.
          </motion.p>
